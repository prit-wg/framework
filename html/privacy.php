...
?>
            <div id="bod_right">
<div id="about_top_s"><span class="greenlar_heading">Privacy Policy</span></div>
<div class="breadcrumb"><a class="a4" href="<?php echo make_url('home');?>">Home</a>&nbsp;&raquo;&nbsp;Privacy Policy</div>
		<?php if($policy->is_preview==0):
		 echo html_entity_decode($policy->page);
		else :
