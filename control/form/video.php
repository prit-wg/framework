...
<ul id="shortcut">
    ...
    ?>
     <li>
    <a href="<?php echo make_admin_url('video', 'list', 'insert');?>" id="shortcut_posts" title="Add New News">
...
switch ($section):
	case 'list':
        ...
        <br class="clear"/>
        <div class="content">
        <form id="form" action="<?=make_admin_url('video', 'update2', 'list', 'page='.$page.'&id='.$id)?>" method="post" name="">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="data" >
			...
			<tr>
				...
				<td align="center" width="25%">
                                        <?=make_admin_link(make_admin_url('video', 'update', 'update', 'id='.$news->id), get_control_icon('edit'), 'Edit News', 'help');?>&nbsp;&nbsp;
                                        <a href="<?php echo make_admin_url('video', 'delete', 'list', 'id='.$news->id); ?>" onclick="return confirm('Are you sure? You are deleting this page.');" class="help" title="Delete News" > <?php echo get_control_icon('cancel');?></a>
	...
	case 'insert':
		...
		?>
		<form id="news_insert" action="<?=make_admin_url('video', 'insert', 'list')?>" method="post" name="news_insert" enctype="multipart/form-data">
                      <div class="twocolumn">
	...
	case 'update':
		...
		?>
		<form id="news_insert" action="<?=make_admin_url('video', 'update', 'list', 'id='.$id)?>" method="post" name="news_insert" enctype="multipart/form-data">
                    <div class="twocolumn">
