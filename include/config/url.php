...
define("DIR_WS_SITE_CSS", DIR_WS_SITE."css/");
define("DIR_WS_SITE_PHP", DIR_WS_SITE."php/");
define("DIR_WS_SITE_HTML", DIR_WS_SITE."html/");
define("DIR_WS_SITE_IMAGE", DIR_WS_SITE."image/",true);
define("DIR_WS_SITE_JAVASCRIPT", DIR_WS_SITE."javascript/",true);
define("DIR_WS_SITE_CONTROL", DIR_WS_SITE."control/",true);

define("DIR_WS_SITE_CONTROL_INCLUDE", DIR_WS_SITE_CONTROL."include/",true);
define("DIR_WS_SITE_CONTROL_IMAGE", DIR_WS_SITE_CONTROL."images/",true);
...
define("DIR_FS_SITE_CSS", DIR_FS_SITE."css/");
define("DIR_FS_SITE_PHP", DIR_FS_SITE."php/");
define("DIR_FS_SITE_HTML", DIR_FS_SITE."html/");
define("DIR_FS_SITE_IMAGE", DIR_FS_SITE."image/",true);
define("DIR_FS_SITE_JAVASCRIPT", DIR_FS_SITE."javascript/",true);
define("DIR_FS_SITE_CONTROL", DIR_FS_SITE."control/",true);
define("DIR_FS_SITE_TEMPLATE", DIR_FS_SITE."template/",true);

define("DIR_FS_SITE_TEMPLATE_INC", DIR_FS_SITE_TEMPLATE."include/",true);
define("DIR_FS_SITE_TEMPLATE_INNER", DIR_FS_SITE_TEMPLATE."include_inner/",true);
