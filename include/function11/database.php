...
function insert_order($cart_id)
{
	...
	if(CART_VAT):
		...
		$data['grand_total']=		($cart_obj->get_cart_vat($cart_obj->get_cart_total())+$cart_obj->get_cart_total()+$cart_obj->GetSHIP($cart_obj->get_cart_total()))-get_var_if_set($more_detail, 'voucher_amount');
		...
		$data['grand_total']=		($cart_obj->get_cart_total()+$cart_obj->GetSHIP($cart_obj->get_cart_total()))-get_var_if_set($more_detail, 'voucher_amount');
		$data['vat']=				$cart_obj->get_cart_vat($cart_obj->get_cart_total());
	endif;
	$data['voucher_code']=		get_var_if_set($more_detail, 'voucher_code');
	$data['voucher_amount']=	(get_var_if_set($more_detail, 'voucher_amount')=='')?0:get_var_if_set($more_detail, 'voucher_amount');
	...
	$data['shipping']=			$cart_obj->GetSHIP($cart_obj->get_cart_total());
...
/*
<select name="sdfsdf">
	<?php echo get_mount_metal_option();?>
</select>
*/
