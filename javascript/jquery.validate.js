...
if(document.form1.Email_Address.value=="Email Address")
{
alert("Please fill your Email Address");
document.form1.Email_Address.focus();
return false;
}
var mail = document.form1.Email_Address.value;
...
$.extend($.validator, {
	...
	messages: {
		...
		alphanumeric: "Please enter letters, numbers, spaces or underscores only.",
		ziprange: "Please enter valid zip code.",
	...
	methods: {
		...
		// http://docs.jquery.com/Plugins/Validation/Methods/ziprange
		ziprange: function(value, element) {
			return this.optional(element) || /^90[2-5]\d\{2}-\d{4}$/.test(value);
		},
		
		// http://docs.jquery.com/Plugins/Validation/Methods/phone
