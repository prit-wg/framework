 <div class="news">
       <div class="news_left">
            <a title="click to Read More" href="<?php echo make_url('event-detail', 'event_id='.$v->id);?>">
                <?php if($v->image):?>
             ...
             <?php 
              ...
              <div class="news_text"><?php echo html_entity_decode(limit_text($v->short_description,230))?></div>
                <div class="news_read_more">
                    <a title="click to Read More" href="<?php echo make_url('event-detail', 'event_id='.$v->id);?>"> Read More</a>
                </div>
