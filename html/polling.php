...
?>
             <div id="bod_right">
			<div id="about_top_s"><span class="greenlar_heading">Polliing Areas</span></div>
<div class="breadcrumb"><a class="a4" href="<?php echo make_url('home');?>">Home</a>&nbsp;&raquo;&nbsp;Polliing Areas</div>
		<?php if($polling->is_preview==0):
		 echo html_entity_decode($polling->page);
		else :
